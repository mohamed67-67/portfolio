            ...
            <a target='_blank' rel="noreferrer" href='https://awesome-kowalevski-c4c181.netlify.app/'>
                <CardActionArea className="internal">
                    ...
                    <div className="det">
                        ...
                        <p>Technologies : <span>HTML</span> <span>CSS</span> <span>JavaScript</span> <span>React.js</span> <span>Redux</span> <span>Material-UI</span> <span>node.js</span> <span>express</span> <span>mongo.DB</span></p>
                    </div>
                </CardActionArea>
            </a>
